DROP DATABASE IF EXISTS nodcms;
CREATE DATABASE nodcms;
...
create user nodcms identified by "W4PeV6EGmElBBpZz";
GRANT USAGE ON *.* TO nodcms;
GRANT SELECT, INSERT, UPDATE, DELETE ON `nodcms`.* TO 'nodcms'@'%';
